        ...
        <div className="flex h-screen w-16 flex-col justify-between border-e fixed top-0 bg-white">
            <div>
                ...
                <div className="border-t border-gray-100">
                    <div className="px-2">
                        <div className="py-4">
                            <Link to="/u" className="t group relative flex justify-center rounded bg-blue-50 px-2 py-1.5 text-blue-700">
                                <AiOutlineHome />
                        ...
                        <ul className="space-y-1 border-t border-gray-100 pt-4">
                            <li>
                                <Link to="/u/friends" className="group relative flex justify-center rounded px-2 py-1.5 text-gray-500 hover:bg-gray-50 hover:text-gray-700">
                                    <AiOutlineTeam />
                            ...
                            <li>
                                <Link to="/u/settings" className="group relative flex justify-center rounded px-2 py-1.5 text-gray-500 hover:bg-gray-50 hover:text-gray-700">
                                    <AiOutlineSetting/>
